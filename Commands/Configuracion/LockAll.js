...
module.exports = {
    name: "lockall",
    aliases: ["lock-all"],
    description: "Cierra todos los canales del servidor",
    ...
    async execute(message, args, commandName, client, Discord) {
        ...
        .setDescription(`${emojis.cargando} | \`Bloqueando la escritura de todos los canales\``)
        .setColor("BLUE")
        ...
        .setTitle("Información")
        .setDescription(`${emojis.positivo} | \`Bloquee todos los canales con exito\``)
        .setColor("GREEN")
