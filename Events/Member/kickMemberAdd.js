            ...
            if(antiraid?.actived) {
                ...
                if(Date.now() - log.createdTimestamp < 5000) {
                    ...
                    if(!userlogs) {
                                ...
                                embeds: [
                                    {
                                        ...
                                        fields: [
                                            {
                                                name: `Acción N°:`,
                                                value: `${a_x001.KickNumber}/${antiraid?.maxKickNumber}`
                                            },
                                            {
                                                name: `Sanción:`,
                        ...
                        if(userlogs?.KickNumber + 1 === antiraid?.maxKickNumber) {
                                        ...
                                        embeds: [
                                            {
                                                ...
                                                fields: [
                                                    {
                                                        name: `Acción N°:`,
                                                        value: `${userlogs.KickNumber}/${antiraid?.maxKickNumber}`
                                                    },
                                                    {
                                                        name: `Sanción:`,
                                                        value: `\`${antiraid?.sancionType}\``
                        ...
                        if(raidlogs?.actived) {
                            ...
                            userlogs.KickNumber = userlogs.KickNumber + 1;
                            await userlogs.save();
                        if(raidlogs) {
                        if(raidlogs?.actived) {
                                 const canal = await guild.channels.cache.get(raidlogs?.channelId);
